<div class="midline_mid">
    <div class="midline_con">
    	...
    	<div class="tab1">
        	{link_to class="linkstyle1" href="#"}Pending{/link_to}
        </div>
        
        <div class="tab2">
        	{link_to class="linkstyle1" href="pm/tickets/view-revised/id/$formid"}Revised{/link_to}
        </div>
        <div class="tab2">
		        	...
		        	<td>
		            	...
		            	<table>
		                	<tr>
		                        ...
		                        <td>
		                        	<span class="textstyle3">Pending Tickets for {$project.project} Project</span>
		                        </td>
		                    </tr>
		                </table>
		                <div class="horlinefade1">	
		                        ...
		                        <tr id="user-{$item.id}" class="table4_td2row{cycle values=1,2}">
		                            ...
		                            <td class="table4_td2a">
                                    	{link_to action="view-detail" id=$item.id}view{/link_to} |
						       			...
						       			{link_to action="revise" id=$item.id}revised{/link_to}
                                    </td>	
		                        </tr>
		                        {foreachelse}
								<tr class="table4_td2">
