...
<div class="midline_mid">
    <div class="midline_con">
        ...
        <div class="tab2">
        	{link_to class="linkstyle1" href="dev/tickets/view-completed/id/$formid"}Completed{/link_to}
        </div>
    </div>
		                        ...
		                        <tr id="user-{$item.id}" class="table4_td2row{cycle values=1,2}">
		                            ...
		                            <td class="table4_td2a">
                                    	{link_to action="view-detail" id=$item.id}view{/link_to}
						       			{link_to action="done" id=$item.id confirm="Are you sure you have completed this task?"}confirm as completed{/link_to}
                                    </td>	
		                        </tr>
		                        {foreachelse}
								<tr class="table4_td2">
