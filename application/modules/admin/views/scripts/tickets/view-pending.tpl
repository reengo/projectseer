...
<div class="midline_mid">
    <div class="midline_con">
		...
		<div class="tab2">
        	{link_to class="linkstyle1" href="admin/tickets/view/id/$formid"}All{/link_to}
        </div>
    	<div class="tab1">
		                        ...
		                        <tr id="user-{$item.id}" class="table4_td2row{cycle values=1,2}">
		                            ...
		                            <td class="table4_td2a">
                                    	{link_to action="view-detail" id=$item.id}view{/link_to} |
						       			...
						       			{link_to action="revise" id=$item.id confirm="This ticket will be sent to the Developer on a Medium Priority Status. Proceed?"}send to dev{/link_to}
                                    </td>	
		                        </tr>
		                        {foreachelse}
								<tr class="table4_td2">
