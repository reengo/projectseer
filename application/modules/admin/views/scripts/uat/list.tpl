...
<div class="midline_mid">
    <div class="midline_con">
        <div class="midline_con_top2">			
            ...
            <div class="tab2">
            	{link_to class="linkstyle1" href="admin/projects/viewqat/id/$formid"}PROJECT INFO{/link_to}
            </div>
            <div class="tab2">
        ...
        <div class="midline_con_mid">
            ...
            <div class="spacer1">
        		{form_button location="/admin/qat/add/id/$formid" name="addreview" value="  add review item  " no_div=true}
        	</div>
        </div>
