...
<div class="midline_con">
	<div class="midline_con_top2">
    	...
    	<div class="tab2">
        	{link_to class="linkstyle1" href="qa/qat/list/id/$qaid"}QA GRID{/link_to}
        </div>
        
        <div class="tab2">
        	{link_to class="linkstyle1" href="qa/projects/viewqat/id/$qaid"}PROJECT INFO{/link_to}
        </div>
        <div class="tab2">
        	{link_to class="linkstyle1" href="qa/qat/report/id/$qaid"}REPORTS{/link_to}
        </div>
    </div>
