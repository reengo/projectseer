...
<div class="midline_con">
	<div class="midline_con_top2">
    	<div class="tab2">
        	{link_to class="linkstyle1" href="qa/qat/list/id/$id"}QA GRID{/link_to}
        </div>
        
        <div class="tab2">
        	{link_to class="linkstyle1" href="qa/projects/viewqat/id/$id"}PROJECT INFO{/link_to}
        </div>
        <div class="tab1">
        	{link_to class="linkstyle1" href="#"}REPORTS{/link_to}
        </div>
    </div>
	                    ...
	                    <table class="table4" cellspacing="0">
	                        ...
	                        <tr>
	                          ...
	                          <td width="770" class="table4_td2a">
	                            	<span class="textstyle4">{$project.status}</span>
	                            </td>
	                      </tr>
	                        <tr>
	                        ...
	                        <tr>
	                        	<td class="table4_td3a">
	                        		{form_button name="excel" value="  Export to Excel   " no_div=true location="#"}
	                        		{form_button name="pdf" value="  Export to PDF   " no_div=true location="#"}
	                        	</td>
	                        	<td></td>
	                        </tr>
	                         <tr>
	                        ...
	                        <tr>
	                        	<td class="table4_td3a">
	                        		&nbsp;&nbsp;&nbsp;{form_textarea name="final_remarks" value="-- Final Remarks --" cols="40" rows="4"}
	                        	</td>
	                        	<td></td>
	                        </tr>
	                        {/if}
	                       <tr>
	                            <td class="table4_td3a" colspan="2">
	                            	{form_button name="continue" value="  continue review   " class="botton" no_div=true location="admin/qat/list/id/$qaid"}
	                            	{form_button name="finalize" value="  finalize   " class="botton" no_div=true location="/admin/qat/finalize"}
	                            </td>
