<?php /* Smarty version 2.6.19, created on 2008-11-19 08:40:23
         compiled from C:%5Cxampp%5Chtdocs%5Ccheck%5Capplication%5Cmodules%5Cchange%5Cviews%5Cscripts%5Cindex%5Cindex.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'flash', 'C:\\xampp\\htdocs\\check\\application\\modules\\change\\views\\scripts\\index\\index.tpl', 22, false),array('function', 'cycle', 'C:\\xampp\\htdocs\\check\\application\\modules\\change\\views\\scripts\\index\\index.tpl', 85, false),array('function', 'paginate_prev', 'C:\\xampp\\htdocs\\check\\application\\modules\\change\\views\\scripts\\index\\index.tpl', 136, false),array('function', 'paginate_middle', 'C:\\xampp\\htdocs\\check\\application\\modules\\change\\views\\scripts\\index\\index.tpl', 136, false),array('function', 'paginate_next', 'C:\\xampp\\htdocs\\check\\application\\modules\\change\\views\\scripts\\index\\index.tpl', 136, false),array('function', 'form_button', 'C:\\xampp\\htdocs\\check\\application\\modules\\change\\views\\scripts\\index\\index.tpl', 148, false),array('block', 'link_to', 'C:\\xampp\\htdocs\\check\\application\\modules\\change\\views\\scripts\\index\\index.tpl', 108, false),array('modifier', 'lower', 'C:\\xampp\\htdocs\\check\\application\\modules\\change\\views\\scripts\\index\\index.tpl', 112, false),array('modifier', 'strip_tags', 'C:\\xampp\\htdocs\\check\\application\\modules\\change\\views\\scripts\\index\\index.tpl', 112, false),)), $this); ?>
<?php echo '
                                    ...
                                    <td class="table4_td2a">
                                    	<?php $this->_tag_stack[] = array('link_to', array('action' => 'view','id' => $this->_tpl_vars['item']['id'])); $_block_repeat=true;smarty_block_link_to($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>view<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_link_to($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?> |
						       			...
						       			<?php if (((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item']['status'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)))) ? $this->_run_mod_handler('strip_tags', true, $_tmp, false) : smarty_modifier_strip_tags($_tmp, false)) == 'approved'): ?>
						       				<?php $this->_tag_stack[] = array('link_to', array('action' => 'revise','id' => $this->_tpl_vars['item']['id'])); $_block_repeat=true;smarty_block_link_to($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>confirm change<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_link_to($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
						       			<?php endif; ?>
						       			<?php if (((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item']['status'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)))) ? $this->_run_mod_handler('strip_tags', true, $_tmp, false) : smarty_modifier_strip_tags($_tmp, false)) == 'changed'): ?>
						       				<?php $this->_tag_stack[] = array('link_to', array('action' => 'close','id' => $this->_tpl_vars['item']['id'])); $_block_repeat=true;smarty_block_link_to($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>close<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_link_to($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
						       			<?php endif; ?>
