<?php /* Smarty version 2.6.19, created on 2008-10-27 11:10:27
         compiled from C:%5Cxampp%5Chtdocs%5Ccheck%5Capplication%5Cmodules%5Cqa%5Cviews%5Cscripts%5Cqat%5Clist.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'flash', 'C:\\xampp\\htdocs\\check\\application\\modules\\qa\\views\\scripts\\qat\\list.tpl', 22, false),array('function', 'cycle', 'C:\\xampp\\htdocs\\check\\application\\modules\\qa\\views\\scripts\\qat\\list.tpl', 121, false),array('function', 'form_checkbox', 'C:\\xampp\\htdocs\\check\\application\\modules\\qa\\views\\scripts\\qat\\list.tpl', 123, false),array('function', 'paginate_prev', 'C:\\xampp\\htdocs\\check\\application\\modules\\qa\\views\\scripts\\qat\\list.tpl', 169, false),array('function', 'paginate_middle', 'C:\\xampp\\htdocs\\check\\application\\modules\\qa\\views\\scripts\\qat\\list.tpl', 169, false),array('function', 'paginate_next', 'C:\\xampp\\htdocs\\check\\application\\modules\\qa\\views\\scripts\\qat\\list.tpl', 169, false),array('block', 'link_to', 'C:\\xampp\\htdocs\\check\\application\\modules\\qa\\views\\scripts\\qat\\list.tpl', 28, false),)), $this); ?>
<?php echo '
...
<div class="midline_mid">
    <div class="midline_con">
        <div class="midline_con_top2">			
            ...
            <div class="tab2">
            	<?php $this->_tag_stack[] = array('link_to', array('class' => 'linkstyle1','href' => "qa/projects/viewqat/id/".($this->_tpl_vars['formid']))); $_block_repeat=true;smarty_block_link_to($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>PROJECT INFO<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_link_to($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
            </div>
            <div class="tab2">
            	<?php $this->_tag_stack[] = array('link_to', array('class' => 'linkstyle1','href' => "qa/qat/report/id/".($this->_tpl_vars['formid']))); $_block_repeat=true;smarty_block_link_to($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>REPORTS<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_link_to($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
            </div>
        </div>
...
">
 ...
 <?php echo smarty_function_paginate_next(array(), $this);?>
            ...
            <div class="spacer1">
        		<?php $this->_tag_stack[] = array('link_to', array('action' => 'add','id' => $this->_tpl_vars['formid'])); $_block_repeat=true;smarty_block_link_to($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Add Review Item<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_link_to($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
        	</div>
        </div>
