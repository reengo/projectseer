...
<div class="midline_mid">
    <div class="midline_con">
		...
		<div class="tab2">
        	{link_to class="linkstyle1" href="dev/tickets"}QA Task Lists{/link_to}
        </div>
    	<div class="tab1">
        	{link_to class="linkstyle1" href="#"}Bug-fix Lists{/link_to}
        </div>
    </div>
		<div class="midline_con_mid">
			<table class="table5" cellspacing="0">
		     ...
		     <div class="spacer1">       		
        		{form_button name="addticket" value="  post ticket  " class="botton" no_div=true location="/dev/tickets/add"}
        	</div>
		</div>
