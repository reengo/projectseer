<?php /* Smarty version 2.6.19, created on 2008-10-27 13:36:09
         compiled from C:%5Cxampp%5Chtdocs%5Ccheck%5Capplication%5Cmodules%5Cdev%5Cviews%5Cscripts%5Ctickets%5Cview-revised.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'link_to', 'C:\\xampp\\htdocs\\check\\application\\modules\\dev\\views\\scripts\\tickets\\view-revised.tpl', 5, false),array('function', 'cycle', 'C:\\xampp\\htdocs\\check\\application\\modules\\dev\\views\\scripts\\tickets\\view-revised.tpl', 71, false),)), $this); ?>
		        	...
		        	<td>
		            	...
		            	<table>
		                	<tr>
		                        ...
		                        <td>
		                        	<span class="textstyle3">Revised Tickets for <?php echo $this->_tpl_vars['project']['project']; ?>
 Project</span>
		                        </td>
		                    </tr>
		                </table>
...
">
		                            ...
		                            <td class="table4_td2a">
                                    	<?php $this->_tag_stack[] = array('link_to', array('action' => "view-detail",'id' => $this->_tpl_vars['item']['id'])); $_block_repeat=true;smarty_block_link_to($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>view<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_link_to($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>                                    	 |
						       			...
						       			<?php $this->_tag_stack[] = array('link_to', array('action' => 'complete','id' => $this->_tpl_vars['item']['id'])); $_block_repeat=true;smarty_block_link_to($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>complete<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_link_to($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
                                    </td>	
		                        </tr>
		                        <?php endforeach; else: ?>
								<tr class="table4_td2">
