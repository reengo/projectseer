<div class="midline_mid">
    <div class="midline_con">
		...
		<div class="tab2">
        	{link_to class="linkstyle1" href="pm/tickets/view/id/$formid"}All{/link_to}
        </div>
    	<div class="tab2">
        	{link_to class="linkstyle1" href="pm/tickets/view-pending/id/$formid"}Pending{/link_to}
        </div>
        
        <div class="tab1">
        	{link_to class="linkstyle1" href="#"}Revised{/link_to}
        </div>
        <div class="tab2">
        	{link_to class="linkstyle1" href="pm/tickets/view-completed/id/$formid"}Completed{/link_to}
        </div>
    </div>
		        	...
		        	<td>
		            	...
		            	<table>
		                	<tr>
		                        ...
		                        <td>
		                        	<span class="textstyle3">Revised Tickets for {$project.project} Project</span>
		                        </td>
		                    </tr>
		                </table>
		                <div class="horlinefade1">	
		                        ...
		                        <tr id="user-{$item.id}" class="table4_td2row{cycle values=1,2}">
		                            ...
		                            <td class="table4_td2a">
                                    	{link_to action="view-detail" id=$item.id}view{/link_to}                                    	 |
						       			...
						       			{link_to action="complete" id=$item.id}complete{/link_to}
                                    </td>	
		                        </tr>
		                        {foreachelse}
								<tr class="table4_td2">
