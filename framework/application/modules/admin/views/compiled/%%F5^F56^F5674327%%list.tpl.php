<?php /* Smarty version 2.6.19, created on 2008-12-02 00:56:38
         compiled from /home/rex2chek/public_html/application/modules/admin/views/scripts/users/list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'flash', '/home/rex2chek/public_html/application/modules/admin/views/scripts/users/list.tpl', 23, false),array('function', 'form_text', '/home/rex2chek/public_html/application/modules/admin/views/scripts/users/list.tpl', 64, false),array('function', 'form_submit', '/home/rex2chek/public_html/application/modules/admin/views/scripts/users/list.tpl', 65, false),array('function', 'form_button', '/home/rex2chek/public_html/application/modules/admin/views/scripts/users/list.tpl', 69, false),array('function', 'cycle', '/home/rex2chek/public_html/application/modules/admin/views/scripts/users/list.tpl', 89, false),array('function', 'paginate_prev', '/home/rex2chek/public_html/application/modules/admin/views/scripts/users/list.tpl', 119, false),array('function', 'paginate_middle', '/home/rex2chek/public_html/application/modules/admin/views/scripts/users/list.tpl', 119, false),array('function', 'paginate_next', '/home/rex2chek/public_html/application/modules/admin/views/scripts/users/list.tpl', 119, false),array('block', 'form', '/home/rex2chek/public_html/application/modules/admin/views/scripts/users/list.tpl', 63, false),array('block', 'link_to', '/home/rex2chek/public_html/application/modules/admin/views/scripts/users/list.tpl', 97, false),array('modifier', 'default', '/home/rex2chek/public_html/application/modules/admin/views/scripts/users/list.tpl', 94, false),)), $this); ?>
<?php echo '
...
">
 ...
 <?php echo $this->_tpl_vars['item']['lastname']; ?>
						    ...
						    <?php if ($this->_tpl_vars['item']['username'] == 'admin'): ?>
						        <td class="table4_td2">
						        <?php $this->_tag_stack[] = array('link_to', array('action' => 'sendpass','id' => $this->_tpl_vars['item']['id'])); $_block_repeat=true;smarty_block_link_to($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>send password<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_link_to($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?> |
